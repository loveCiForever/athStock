...
var D = class {
  ...
  fillImage(a) {
    ...
    let r = "load";
    i === "VIDEO" && (s.autoplay = true, s.loop = true, s.muted = true, s.playsinline = true, r = "loadeddata"), this.nodes.imageEl = S(i, this.CSS.imageEl, s), this.nodes.imageEl.addEventListener(r, () => {
      this.toggleStatus(
        "filled"
        /* Filled */
  ...
  (function(i, s) {
    ...
    return function(i) {
      ...
      function r(o) {
        ...
        return i[o].call(e.exports, e, e.exports, r), e.l = true, e.exports;
      }
...
var P = class _P {
  ...
  render() {
    var a, i, s;
    return (((a = this.config.features) == null ? void 0 : a.caption) === true || ((i = this.config.features) == null ? void 0 : i.caption) === void 0 || ((s = this.config.features) == null ? void 0 : s.caption) === "optional" && this.data.caption) && (this.isCaptionEnabled = true), this.ui.render();
  }
  /**
  ...
  renderSettings() {
    var o;
    const a = _P.tunes.concat(this.config.actions || []), i = {
      border: "withBorder",
  ...
  set data(a) {
    this.image = a.file, this._data.caption = a.caption || "", this.ui.fillCaption(this._data.caption), _P.tunes.forEach(({ name: i }) => {
      const s = typeof a[i] < "u" ? a[i] === true || a[i] === "true" : false;
      this.setTune(i, s);
    }), a.caption && this.setTune("caption", true);
  }
  /**
   * Return Tool data
   */
   ...
   */
  tuneToggled(a, i) {
    a === "caption" ? (this.ui.applyTune(a, i), i == false && (this._data.caption = "", this.ui.fillCaption(""))) : this.setTune(a, i);
  }
  /**
   * Set one tune
