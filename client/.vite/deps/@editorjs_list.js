...
var Je = {};
var he = {};
var j = A && A.__spreadArray || function(e, t, n) {
  if (n || arguments.length === 2)
    for (var r = 0, i = t.length, a; r < i; r++)
      (a || !(r in t)) && (a || (a = Array.prototype.slice.call(t, 0, r)), a[r] = t[r]);
  return e.concat(a || Array.prototype.slice.call(t));
...
function kn(e) {
  return Array.from(e.querySelectorAll((0, Sn.allInputsSelector)())).reduce(function(t, n) {
    return (0, On.isNativeInput)(n) || (0, yn.containsOnlyInlineElements)(n) ? j(j([], t, true), [n], false) : j(j([], t, true), (0, Cn.getDeepestBlockElements)(n), true);
  }, []);
}
(function(e) {
...
var K = class {
  ...
  backspace(t) {
    var r;
    const n = this.currentItem;
    if (n !== null && P.isCaretAtStartOfInput(n) && ((r = window.getSelection()) == null ? void 0 : r.isCollapsed) !== false) {
  ...
  unshiftItem(t) {
    ...
    i !== null && (r === null && (r = this.renderer.renderWrapper(false)), i.forEach((a) => {
      r.appendChild(a);
    }), t.appendChild(r)), n.after(t), E(t, false), z(n);
  }
  /**
  ...
  splitItem(t) {
    ...
    const i = N(t);
    let a;
    i === null ? a = "" : a = P.getContenteditableSlice(i, n, r, "right", true);
